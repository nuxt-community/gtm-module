...
module.exports = async function gtmModule(_options) {
  ...
  const renderIframe = id => (queryString !== null && queryString !== '') ? `<iframe src="${options.noscriptURL + '?id=' + id + '&' + queryString}" height="0" width="0" style="display:none;visibility:hidden" title="gtm"></iframe>` : `<iframe src="${options.noscriptURL + '?id=' + id }" height="0" width="0" style="display:none;visibility:hidden" title="gtm"></iframe>`
  if (options.noscript) {
